<template>
  <div class="container mt-4">
    ...
    <div class="row mb-3">
      ...
      <div class="col-md-2">
        <button class="btn btn-primary w-100" @click="abrirCrear">Nuevo Colegio</button>
      </div>
    </div>
      ...
      <tbody>
        <tr v-for="colegio in colegiosFiltrados" :key="colegio.id">
          ...
          <td class="text-center">
            <button class="btn btn-sm btn-warning me-2" @click="abrirEditar(colegio)">Editar</button>
            <button class="btn btn-sm btn-danger" @click="eliminarColegio(colegio.id)">Eliminar</button>
          </td>
        </tr>
      </tbody>
    </table>
    ...
    <ColegioFormModal
      ...
      :colegio-editado="colegioEditado"
      @cerrar="cerrarModal"
      @guardar="cargarColegios"
    />
  </div>
</template>
